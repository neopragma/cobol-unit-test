...
```
       working-storage section.
      * (this code becomes part of the production program)
       01  filler                     pic  x value 'Y'.
           88  set-current-date              value 'Y'.
           88  do-not-set-current-date       value 'N'.
       ...
       procedure division.
       . . .
       * (this code is injected by the unit test framework)       
           ...
           perform 3400-next-invoice-date
           ...
           move "It determines the next invoice date in February, non le
      -         "ap year" 
               to test-case-name
           ...
           move "It determines the next invoice date in February, leap y
      -         "ear" 
               to test-case-name
